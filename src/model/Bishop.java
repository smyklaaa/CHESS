...
public class Bishop extends ChessPieces {
    ...
    public  Bishop(boolean check_if_white){
        super("Bishop",check_if_white,check_if_white ? "♝" : "♗");
    }
    ...
    public void check_available_moves(int where_is_now_x,int where_is_now_y,int where_to_go_x,
        ...
        i= 1;
        while(where_is_now_x+i<8 && where_is_now_y+i<8 &&
        ...
        if(where_is_now_x+i<8 && where_is_now_y+i<8 &&
                chessboard.fields[where_is_now_x+i][where_is_now_y+i].which_piece_on_field != null){
        ...
        i= 1;
        while(where_is_now_x-i>0 && where_is_now_y+i<8 &&                                                                   //nie wykonuja sie skrajnosciowe pola
                chessboard.fields[where_is_now_x-i][where_is_now_y+i].which_piece_on_field == null){
            String available_move = (where_is_now_x -i) + ""+(where_is_now_y+i) ;
            available_moves.add(available_move);
            i++;
        }
        if(where_is_now_x-i>0 && where_is_now_y+i<8 &&
                chessboard.fields[where_is_now_x-i][where_is_now_y+i].which_piece_on_field != null){
            if(chessboard.fields[where_is_now_x-i][where_is_now_y+i].which_piece_on_field.return_color() !=
        ...
        i= 1;
        while(where_is_now_x+i<8 && where_is_now_y-i>0 &&
                chessboard.fields[where_is_now_x+i][where_is_now_y-i].which_piece_on_field == null){
            String available_move = (where_is_now_x +i) + ""+(where_is_now_y-i) ;
            available_moves.add(available_move);
            i++;
        }
        if(where_is_now_x+i<8 && where_is_now_y-i>0 &&
                chessboard.fields[where_is_now_x+i][where_is_now_y-i].which_piece_on_field != null){
            if(chessboard.fields[where_is_now_x+i][where_is_now_y-i].which_piece_on_field.return_color() !=
                    chessboard.fields[where_is_now_x][where_is_now_y].which_piece_on_field.return_color()){
                String available_move = (where_is_now_x +i) + ""+(where_is_now_y-i) ;
        ...
        i= 1;
        while(where_is_now_x-i>0 && where_is_now_y-i>0 &&
                chessboard.fields[where_is_now_x-i][where_is_now_y-i].which_piece_on_field == null){
            String available_move = (where_is_now_x -i) + ""+(where_is_now_y-i) ;
            available_moves.add(available_move);
            i++;
        }
        if(where_is_now_x-i>0 && where_is_now_y-i>0 &&
                chessboard.fields[where_is_now_x-i][where_is_now_y-i].which_piece_on_field != null){
            if(chessboard.fields[where_is_now_x-i][where_is_now_y-i].which_piece_on_field.return_color() !=
                    chessboard.fields[where_is_now_x][where_is_now_y].which_piece_on_field.return_color()){
                String available_move = (where_is_now_x -i) + ""+(where_is_now_y-i) ;
